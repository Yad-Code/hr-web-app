  ...
  return (
    <div className="bg-white border border-slate-100 rounded-2xl shadow-sm p-6">
      <div className="flex items-center gap-2 mb-4 pb-3 border-b border-slate-100">
        ...
        <span className="ml-auto text-[10px] text-slate-400 font-medium">Read-only (Admin only)</span>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-start gap-3">
          <Briefcase className="w-4 h-4 text-slate-400 mt-0.5 flex-shrink-0" />
          <div className="flex-1">
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Department & Branch</p>
            <p className="text-sm font-semibold text-slate-900">{profile.department || "N/A"}</p>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm font-semibold text-slate-900">{profile.gender || "N/A"}</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm font-semibold text-slate-900">{profile.nationality || "N/A"}</p>
          </div>
        </div>
      </div>
    </div>
