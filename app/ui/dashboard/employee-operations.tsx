...
export function EmployeeOperations() {
  return (
    <div className="p-6 flex flex-col gap-3 h-full justify-center"> 
      <Link 
        href="/my-profile?action=leave" 
        className="w-full flex items-center gap-3 p-4 rounded-xl border border-slate-200 hover:border-[#009473] hover:bg-[#eaf8f5] transition-all group text-left active:scale-[0.99]"
      >
        <div className="w-10 h-10 rounded-full bg-slate-50 group-hover:bg-white flex items-center justify-center shrink-0">
