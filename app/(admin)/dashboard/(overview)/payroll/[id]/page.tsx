...
import { fetchPayStubDetails, fetchPayStubItems } from "@/app/lib/admin/payroll/data";
import { markAsPaid } from "@/app/lib/admin/payroll/actions";
...
export default async function PayStubDetailsPage({ params }: PageProps) {
  ...
  if (!payStub) return <div>Pay stub not found.</div>;
