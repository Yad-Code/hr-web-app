...
// 👇 Updated Import Path
import { AdminPayrollTable } from "./_components/AdminPayrollTable";
...
export default async function AdminPayrollPage() {
  ...
  if (!isAuthorized) {
    return (
      <main className="min-h-[60vh] flex flex-col items-center justify-center p-6 text-center animate-fadeIn">
  ...
  return (
    <main className="max-w-7xl mx-auto w-full p-4 sm:p-6 lg:p-8 animate-fadeIn">
